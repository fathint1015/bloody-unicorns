  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-sm": "0 0 15px oklch(0.54 0.28 22 / 0.35)",
        "glow-md": "0 0 30px oklch(0.54 0.28 22 / 0.5), 0 0 60px oklch(0.54 0.28 22 / 0.25)",
        "glow-lg": "0 0 50px oklch(0.54 0.28 22 / 0.6), 0 0 100px oklch(0.54 0.28 22 / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          ...
          "50%": {
            "box-shadow": "0 0 30px oklch(var(--accent) / 0.6), 0 0 60px oklch(var(--accent) / 0.3)"
          },
        },
        "fade-in": {
          from: { opacity: "0" },
